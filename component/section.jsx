...
const Section = () =>{
    return <section class="relative py-32 lg:py-36 bg-white">
    <div
            ...
            <div class="mt-10  w-full flex max-w-md mx-auto lg:mx-0">
                <div class="flex sm:flex-row flex-col gap-5 w-full">
                    <form action="#"
                        ...
                        <button class="flex text-white justify-center items-center w-max min-w-max sm:w-max px-6 h-12 rounded-md outline-none relative overflow-hidden border duration-300 ease-linear
